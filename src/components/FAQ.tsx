      ...
      <div className="container-custom">
        ...
        <div className="mt-8 max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
            ...
            <AccordionItem value="item-2" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
              <AccordionTrigger className="px-6">
                營業登記需要多久時間？
              </AccordionTrigger>
              <AccordionContent className="px-6">
            ...
            <AccordionItem value="item-3" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
              <AccordionTrigger className="px-6">
                什麼是「全額退款保證」？
              </AccordionTrigger>
              <AccordionContent className="px-6">
            ...
            <AccordionItem value="item-4" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
              <AccordionTrigger className="px-6">
                會議室使用有什麼限制？
              </AccordionTrigger>
              <AccordionContent className="px-6">
            ...
            <AccordionItem value="item-5" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
              <AccordionTrigger className="px-6">
                免費稅務諮詢包括哪些內容？
              </AccordionTrigger>
              <AccordionContent className="px-6">
            ...
            <AccordionItem value="item-6" className="bg-white mb-3 rounded-md border border-gray-100 shadow-sm">
              <AccordionTrigger className="px-6">
                押金何時可以退還？
              </AccordionTrigger>
              <AccordionContent className="px-6">
        ...
        <div className="mt-12 bg-white p-8 rounded-md shadow-sm border border-gray-200 max-w-2xl mx-auto text-center">

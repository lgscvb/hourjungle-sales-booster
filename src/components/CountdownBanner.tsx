...
const CountdownBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-brand-blue to-brand-dark-blue text-white py-3 animate-pulse-slow">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center text-center gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-1 font-mono">
            <div className="flex flex-col items-center">
              <span className="bg-white text-brand-blue px-2 py-1 rounded-md text-sm md:text-base font-bold">

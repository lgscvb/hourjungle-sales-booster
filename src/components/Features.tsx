      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          ...
          <div className="feature-card">
            <div className="rounded-full bg-brand-light-purple w-12 h-12 flex items-center justify-center mb-4">
            ...
            <div className="border-t border-gray-100 pt-4 mt-auto">
              <h4 className="font-semibold text-brand-purple mb-2">我們的解決方案</h4>
          ...
          <div className="feature-card">
            <div className="rounded-full bg-brand-light-purple w-12 h-12 flex items-center justify-center mb-4">
              <Check className="text-brand-purple" size={24} />
            </div>
        ...
        <div className="mt-16 bg-brand-light-purple p-6 rounded-lg border border-brand-purple/20">
          <h3 className="text-2xl font-bold text-center mb-6">還在猶豫什麼？</h3>
          <p className="text-center text-lg mb-8">
            每延遲一天決策，就是<span className="text-brand-purple font-bold">錯失一天商機</span>，
            讓專業的我們為您解決所有煩惱！
          </p>
